...
class BaseTNModel(torch.nn.Module):
    def __init__(self, target, init_reso, max_rank=256, dtype='float32', loss_fn_str="L2", use_TTNF_sampling=False, payload=0, payload_position="grayscale", canonization="first", activation="None", compression_alg="compress_all", regularization_type="TV", dimensions=2, noisy_target=None, device = 'cpu', masked_avg_pooling = False, sigma_init=0, ranks_for_upsampling = None):
        ...
        self.ranks_for_upsampling = ranks_for_upsampling
        ...
        self.downsampled_target_temp = self.downsampled_target.clone()
        ...
        self.l1_loss, self.l2_loss = self.get_all_loss()
